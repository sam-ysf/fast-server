...
namespace fserv {
    ...
    {
        ssize_t ret = ::recv(sfd, buff, static_cast<std::uint32_t>(bufflen), 0);
    ...
    {
        ssize_t ret = ::send(sfd, buff, static_cast<std::uint32_t>(bufflen), 0);
        return static_cast<int>(ret);
    }
                              ...
                              int bufflen)
    {
        ...
        ssize_t ret = ::sendto(sfd,
                               buff,
                               static_cast<std::uint32_t>(bufflen),
                               0,
                               reinterpret_cast<struct sockaddr*>(&addr),
                               sizeof(sockaddr_in));
        return static_cast<int>(ret);
