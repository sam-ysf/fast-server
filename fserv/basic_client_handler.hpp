...
namespace fserv {
    ...
    template <typename ClientType>
    using basic_client_error
        = enable_client_error<BasicClientHandler<ClientType>, ClientType>;

    template <typename ClientType>
    using basic_client_accepted
        = enable_client_accepted<BasicClientHandler<ClientType>, ClientType>;

    template <typename ClientType>
    using basic_client_closed
        = enable_client_closed<BasicClientHandler<ClientType>, ClientType>;

    template <typename ClientType>
    using basic_client_received
        = enable_client_data_received<BasicClientHandler<ClientType>,
                                      ClientType>;

    template <typename ClientType>
    using basic_client_oob_received
        = enable_client_oob_received<BasicClientHandler<ClientType>,
                                     ClientType>;
     ...
     */
    template <typename ClientType>
    class BasicClientHandler : public basic_client_error<ClientType>,
                               public basic_client_accepted<ClientType>,
                               public basic_client_closed<ClientType>,
                               public basic_client_received<ClientType>,
                               public basic_client_oob_received<ClientType> {
    ...
    public:
        ...
        //! @param client
        //!     Triggered client
        bool client_accepted(ClientSessionType& client)
        {
